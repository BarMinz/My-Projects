# This is a CI Project built on an existing java project
I used github actions in order to test the app for vulnerabilities, scan its dependencies and check run static analysis on it, before building and delivering an image, signing and verifyign it.
# App's README
